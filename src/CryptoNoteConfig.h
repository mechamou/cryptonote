...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(71427321893);
...
const uint64_t DIFFICULTY_TARGET                             = 22; // seconds
...
const char     CRYPTONOTE_NAME[]                             = "mechamou";
...
const int      P2P_DEFAULT_PORT                              = 2741;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 2742;
